...
import codes.oss.socketio.handler.SuccessAuthorizationListener;
import codes.oss.socketio.listener.DefaultExceptionListener;
import codes.oss.socketio.listener.ExceptionListener;
import codes.oss.socketio.protocol.JsonSupport;
import codes.oss.socketio.store.MemoryStoreFactory;
import codes.oss.socketio.store.RedissonStoreFactory;
import codes.oss.socketio.store.StoreFactory;
import codes.oss.socketio.store.HazelcastStoreFactory;
...
public class Configuration {
    ...
    private boolean useLinuxNativeIOUring;
    ...
    Configuration(Configuration conf) {
        ...
        if (conf.getJsonSupport() == null) {
            try {
                ...
                try {
                    Class<?> jjs = getClass().getClassLoader().loadClass("codes.oss.socketio.protocol.JacksonJsonSupport");
